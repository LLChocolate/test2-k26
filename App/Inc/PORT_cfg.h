...
#define UART1_RX_PIN    PTE1        //PTA18、PTE1、PTC3                       PTA18不要用 （与晶振冲突）
#define UART1_TX_PIN    PTE0        //PTA19、PTE0、PTC4                       PTA19不要用 （与晶振冲突）
...
#define TPM_CLKIN0_PIN  PTE29       //PTA18、PTB16、PTC12、PTE16、PTE29     PTA18不要用 （与晶振冲突）
#define TPM_CLKIN1_PIN  PTE30       //PTA19、PTB17、PTC13、PTE17、PTE30              PTA19不要用 （与晶振冲突）
